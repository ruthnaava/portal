...
// Fetch teachers not yet marked present today
$teachers = [];
$res = $mysqli->query("SELECT id, name, phone, email FROM teachers WHERE id NOT IN (SELECT attendedid FROM attendance WHERE date=CURDATE() AND role='teacher')");
if ($res) {
...
<head>
    ...
    <title>Teacher Attendance - Admin Panel | MIU SCIENCE FACULTY PORTAL</title>
...
<body>
    ...
    <main class="main-content" id="mainContent">
        <div class="attendance-table-container">
            <h2>Teacher Attendance List</h2><hr/>
            <table class="attendance-table">
                ...
                <?php if (count($teachers) === 0): ?>
                    <tr><td colspan="5" style="text-align:center; color:#888;">All teachers have been marked present today.</td></tr>
                <?php else: ?>
                    <?php foreach ($teachers as $teacher): ?>
                        <tr>
                            <td>
                                <form action="attendTeacher.php" method="post" style="margin:0;">
