...
// Fetch students not yet marked present today
$students = [];
$res = $mysqli->query("SELECT id, name, phone, email FROM students WHERE id NOT IN (SELECT attendedid FROM attendance WHERE date=CURDATE() AND role='student')");
if ($res) {
...
<head>
    ...
    <title>Student Attendance - Admin Panel | MIU SCIENCE FACULTY PORTAL</title>
...
<body>
    ...
    <main class="main-content" id="mainContent">
        <div class="attendance-table-container">
            <h2>Student Attendance List</h2><hr/>
            <table class="attendance-table">
                ...
                <?php if (count($students) === 0): ?>
                    <tr><td colspan="5" style="text-align:center; color:#888;">All students have been marked present today.</td></tr>
                <?php else: ?>
                    <?php foreach ($students as $student): ?>
                        <tr>
                            <td>
                                <form action="attendStudent.php" method="post" style="margin:0;">
